...
#ifndef SURF_GRIDPOINT_H
#define SURF_GRIDPOINT_H
...
namespace store
{
    ...
    public:
        ...
        SurfGridPoint( const SurfGridPoint & GPOINT)
        : math::Function< t_INPUT, t_RETURN>( GPOINT)
        {}

        virtual ~SurfGridPoint(){}

        virtual SurfGridPoint *Clone() const
        { return new SurfGridPoint( *this);}
        ...
        {
	    STREAM << util::EnumHandler< util::FunctorEnum>().String( util::e_SurfGridPoint) << " ";
            return STREAM;
        }
        ...
        {
        	return util::e_SurfGridPoint;
        }


    }; // end class SurfGridPoint


    template< typename t_INPUT, typename t_RETURN>
    const t_RETURN SurfGridPoint< t_INPUT, t_RETURN>::s_Zero = factory::BuildNeutralObject< t_RETURN>();
